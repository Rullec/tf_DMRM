...
class DataLoader(object):
	...
	def __init__(self, datadir, test_split = 0.05):
		'''
	...
	def get_test_data(self, NeedNum=0.05):
	...
	def get_next_batch(self, batch_size=32, datatype='single', simplify = 0.2):
		'''
...
if __name__ =='__main__':
	...
	for img, label, name in loader.get_next_batch(batch_size=32, simplify=0.2):
